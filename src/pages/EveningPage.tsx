    ...
    return (
      <div className="space-y-6 animate-fade-in">
        ...
        <div className="flex gap-3">
          <button className="btn-secondary flex-1" onClick={() => setStep(1)}>Изменить</button>
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      {step === 1 && (
        <>
                    ...
                    <button
                      ...
                      className={`flex-1 h-11 rounded-xl text-[15px] font-medium transition-all duration-150 ${
                        harmony[key].score === n
                          ...
                          : 'bg-cream text-graphite-secondary hover:bg-paper/80'
                      }`}
                    >
                      {n}
                    </button>
          ...
          <button className="btn-primary w-full" onClick={() => setStep(2)}>Далее</button>
        </>
      )}
      ...
      {step === 2 && (
        <>
          ...
          />
          <p className="text-[13px] text-graphite-secondary bg-cream rounded-2xl px-4 py-3">
          ...
          <div className="flex gap-3">
            ...
            <button className="btn-primary flex-1" disabled={!distortion.trim()} onClick={() => setStep(3)}>
              Далее
            </button>
          </div>
        </>
        ...
        <>
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <div className="flex gap-3 mt-2">
                <button
                  ...
                  className={`flex-1 py-3.5 rounded-2xl font-medium text-[15px] transition-all ${
                    wouldDoInPrivate ? 'bg-olive-soft text-olive ring-2 ring-olive/20' : 'bg-cream text-graphite-secondary'
                  }`}
                >
                  Да
                </button>
                <button
                  ...
                  className={`flex-1 py-3.5 rounded-2xl font-medium text-[15px] transition-all ${
                    !wouldDoInPrivate ? 'bg-cream text-graphite ring-2 ring-paper' : 'bg-cream text-graphite-secondary'
                  }`}
                >
                  Нет
                </button>
              ...
              {!wouldDoInPrivate && (
                <p className="text-[13px] text-graphite-secondary mt-3 bg-cream rounded-2xl px-4 py-3">
